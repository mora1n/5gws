...
export interface Metric { timestamp: number; process_count: number; rss_bytes: number; swap_bytes: number; tcp_connections: number; rx_bytes: number; tx_bytes: number; interface: string; dns_ok: boolean; dns_latency_ms: number }
