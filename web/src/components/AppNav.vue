<template>
  ...
  <nav class="fixed inset-x-0 bottom-0 z-30 grid h-16 grid-cols-6 border-t border-base-300 bg-base-100 lg:hidden">
...
import { Activity, ListTree, LogOut, Network, Route, Settings } from '@lucide/vue'
...
const items = [
  ...
  { id: 'rules', label: '规则', short: '规则', icon: ListTree }, { id: 'exits', label: '出口', short: '出口', icon: Route },
  { id: 'logs', label: '日志', short: '日志', icon: Activity },
